    ...
    <div class="collapse navbar-collapse">
        ...
        <ul class="navbar-nav">
            <li class="nav-item active">
                <a href="./school" class="nav-link">Home <span class="sr-only">(current)</span></a>
            </li>
            @if (Auth::guest())
                <li class="nav-item">
            ...
            @else
                <li class="nav-item dropdown btn-group">
                    ...
                    <div class="dropdown-menu dropdown-menu-right dropdown" aria-labelledby="dropdownMenu1">
                        <a class="dropdown-item primary-hover">My Profile</a>
                        <a href="{{ route('logout') }}" class="dropdown-item primary-hover" onclick="event.preventDefault();
                                                     document.getElementById('logout-form').submit();">
                                                     Log out</a>
                        @if(Auth::user()->account_type == 'admin') 
                            <a class="dropdown-item primary-hover">Control Panel (Admin)</a>
                        @endif
                    </div>
                </li>
